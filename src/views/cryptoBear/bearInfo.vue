                ...
                <div class="bear-content">
                   <div class="bc-left">
                       ...
                       <div class="btnbox">
                               ...
                               <a class="pointer cb-btn upbtn ">升级</a>
                           </div>
                   </div>
                   <div class="bc-right">
                       ...
                       <div class="detailInfo">
                            <h3 class="h-level">
                                当前等级<span class="s-level">1</span>
                            </h3>
